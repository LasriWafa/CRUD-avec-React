...
const CustomerComponent = ({ load, customers }) => {
    ...
    async function deleteCustomer(idRef) { // TP says id, but function passes identityRef or id? 
        // In CustomerList: onClick={() => deleteCustomer(customer.identityRef)}
        // So the argument here is identityRef.
        await api.delete("/delete/" + idRef);
